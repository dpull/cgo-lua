...
func getTestData() []LuaValue {
	tab := make(LuaTable)
	tab[int64(1)] = "a"
	tab[float64(2)] = "b"

	return []LuaValue{int64(300), 5.1, "str", tab}
}

func test(t *testing.T, want []bool, src interface{}, cmp func(v LuaValue)) {
	data := getTestData()
...
func TestConvertInt(t *testing.T) {
	...
	var dst1 int8
	test(t, want, &dst1, func(v LuaValue) {
		require.EqualValues(t, v, dst1)
	})

	var dst2 int16
	test(t, want, &dst2, func(v LuaValue) {
...
func TestConvertFloat(t *testing.T) {
	...
	var dst float32
	test(t, want, &dst, func(v LuaValue) {
